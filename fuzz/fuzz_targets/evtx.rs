// EVTX Parser fuzz target（T4-092、F-025、互換 §12-2）。
//
// libFuzzer が生成した raw bytes を EVTX 形式と見なして Parser へ投げ、
...
use tf_core::id;
use tf_parsers::evtx::{EvtxParser, PARSER_ID, PARSER_VERSION};
...
fn make_context(data_len: u64) -> ParseContext {
    ...
    let evidence = EvidenceItem {
        evidence_id: id::evidence_id("Security.evtx", data_len, &sha),
